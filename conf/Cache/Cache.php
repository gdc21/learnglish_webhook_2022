...
class Cache
{
    ...
    public static $config = array(
        'cache_path' => 'carpetaAlmacenamientoCache',
    ...
    {
        #echo "Llegueeeeeeeeeeeeeeeeeeeeee: ".$key['cache_dir'];
        if (is_array($key)) {
    ...
    {
        return __DIR__. "/".static::$config['cache_path'] . '/' . md5($key) . '.php';
    }
    ...
    {
        #echo ">>>>>>>>>>>>>>>>".__DIR__. "/".self::$config['cache_path'] ;
        $cache_files = glob(__DIR__. "/".self::$config['cache_path'] . '/*.php', GLOB_NOSORT);
