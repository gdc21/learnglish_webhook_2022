...
<div class="col-xs-2 col-sm-3"></div>
  ...
  <div id="div-error">
  <img id="img-error" src="<?=CONTEXT?>/error_pages/ErrorBosqueSinBotones.png"/>
    <img class="salir" src="<?=CONTEXT?>/error_pages/SalirAmarillo.png"/>
   <img class="volver" src="<?=CONTEXT?>/error_pages/VolverAmarillo.png"/>
  </div>
