...
(function (_) {
    ...
    try {
        ...
        Za("Symbol", function (a) {
            ...
            var b = function (f, g) {
                this.g = f;
                Wa(this, "description", { configurable: !0, writable: !0, value: g });
            };
        ...
        Za("Promise", function (a) {
            ...
            e.race = function (g) {
                return new e(function (k, l) {
                    for (var m = _.ab(g), n = m.next(); !n.done; n = m.next()) c(n.value).Id(k, l);
                });
            };
            e.all = function (g) {
                var k = _.ab(g),
                ...
                return l.done
                    ...
                    : new e(function (m, n) {
                          ...
                          var r = [],
                              v = 0;
                          do r.push(void 0), v++, c(l.value).Id(q(r.length - 1), n), (l = k.next());
                          while (!l.done);
                      });
            };
            return e;
        ...
        Za("WeakMap", function (a) {
            ...
            k.prototype.delete = function (l) {
                return c(l) && kb(l, f) && kb(l[f], this.g) ? delete l[f][this.g] : !1;
            };
            return k;
        });
        Za("Map", function (a) {
            ...
            c.prototype.set = function (k, l) {
                ...
                m.Pa ? (m.Pa.value = l) : ((m.Pa = { next: this.g, Ib: this.g.Ib, head: this.g, key: k, value: l }), m.list.push(m.Pa), (this.g.Ib.next = m.Pa), (this.g.Ib = m.Pa), this.size++);
                return this;
            };
            c.prototype.delete = function (k) {
                k = d(this, k);
                return k.Pa && k.list ? (k.list.splice(k.index, 1), k.list.length || delete this.h[k.id], (k.Pa.Ib.next = k.Pa.next), (k.Pa.next.Ib = k.Pa.Ib), (k.Pa.head = null), this.size--, !0) : !1;
            };
            ...
            var d = function (k, l) {
                    ...
                    if (n && kb(k.h, m))
                        for (k = 0; k < n.length; k++) {
                            var q = n[k];
                            if ((l !== l && q.key !== q.key) || l === q.key) return { id: m, list: n, index: k, Pa: q };
                        }
        ...
        var mb =
            "function" == typeof Object.assign
                ...
                : function (a, b) {
                      for (var c = 1; c < arguments.length; c++) {
                          var d = arguments[c];
                          if (d) for (var e in d) kb(d, e) && (a[e] = d[e]);
                      }
                      return a;
                  };
...
*/
        ...
        _.Cb = function () {
            if (void 0 === Bb) {
                ...
                if (b && b.createPolicy) {
                    try {
                        a = b.createPolicy("goog#html", { createHTML: xb, createScript: xb, createScriptURL: xb });
                    } catch (c) {
        ...
        ud = { SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1 };
        vd = { IMG: " ", BR: "\n" };
        _.xd = function (a) {
            var b = [];
            _.wd(a, b, !0);
        ...
        _.Dd = function (a, b) {
            ...
            if (a) {
                ...
                d
                    ...
                    : ((this.offsetX = _.D || void 0 !== a.offsetX ? a.offsetX : a.layerX),
        ...
        Jd.prototype.add = function (a, b, c, d, e) {
            ...
            a || ((a = this.g[f] = []), this.h++);
            var g = Kd(a, b, d, e);
            -1 < g ? ((b = a[g]), c || (b.Hd = !1)) : ((b = new Hd(b, this.src, f, !!d, e)), (b.Hd = c), a.push(b));
            return b;
        };
        ...
        Jd.prototype.cd = function (a, b, c, d) {
            a = this.g[a.toString()];
            var e = -1;
            a && (e = Kd(a, b, c, d));
            return -1 < e ? a[e] : null;
        ...
        var Kd = function (a, b, c, d) {
            for (var e = 0; e < a.length; ++e) {
                var f = a[e];
                if (!f.Ic && f.listener == b && f.capture == !!c && f.Yd == d) return e;
            }
            return -1;
        };
        ...
        _.Qd = function (a, b, c, d, e) {
            ...
            c = Rd(c);
            return _.Fd(a) ? a.Tb(b, c, _.ya(d) ? !!d.capture : !!d, e) : Sd(a, b, c, !0, d, e);
        };
        _.Xd = function (a, b, c, d, e) {
            if (Array.isArray(b)) for (var f = 0; f < b.length; f++) _.Xd(a, b[f], c, d, e);
            else (d = _.ya(d) ? !!d.capture : !!d), (c = Rd(c)), _.Fd(a) ? a.sa(b, c, d, e) : a && (a = _.Td(a)) && (b = a.cd(b, c, d, e)) && _.Yd(b);
        };
        _.Yd = function (a) {
            if ("number" === typeof a || !a || a.Ic) return !1;
            var b = a.src;
        ...
        Wd = function (a, b) {
            return a.Ic ? !0 : _.Zd(a, new _.Dd(b, this));
        };
        _.Td = function (a) {
            a = a[Nd];
        ...
        _.h.dispatchEvent = function (a) {
            ...
            if (b) for (f = 0; !a.h && f < b.length; f++) (g = a.currentTarget = b[f]), (e = _.ae(g, d, !1, a) && e);
            return e;
        };
        _.h.L = function () {
            _.I.G.L.call(this);
        ...
        _.I.prototype.cd = function (a, b, c, d) {
            return this.gb.cd(String(a), b, c, d);
        };
...
*/
        ...
        _.h.Qf = function (a, b) {
            if (!(this instanceof Ve)) this.Qf(a, b);
                ...
                for (var c = [], d = 0; d < a.length; d++) {
                    ...
                    c.push(f);
                    this.g[f] ? ((f = this.g[f].xc()), f != e && f.splice.apply(f, [0, f.length].concat(_.bb(e)))) : (this.g[f] = new Nb(e, f));
                }
        ...
        Ve.prototype.ta = function (a, b, c) {
            ...
            if (0 !== b.length) {
                ...
                a = (0, _.x)(this.C.T, this.C, _.wa(b), this.g, { xi: this.V, zi: !!c, Df: (0, _.x)(this.ba, this, this.l, b), Cj: (0, _.x)(this.la, this) });
        ...
        var bf = function (a, b) {
            ...
            cf = function (a, b) {
                ...
                for (var e = 0; e < b.length; e++)
                    for (var f = a.g[b[e]].xc(), g = f.length - 1; 0 <= g; g--) {
                        var k = f[g];
            ...
            Xe = function (a) {
                a.o == a.K && ((a.o = null), Qb(a.K, (0, _.x)(a.Jg, a)) && df(a, 4), Ze(a));
            },
            na = function (a) {
                if (a.o) {
                    var b = a.o.hb();
                    a.Bb() || (Qb(a.g[b], (0, _.x)(a.Jg, a)) && df(a, 4), _.va(a.s, b), _.va(a.j, b), 0 === a.j.length && ef(a), a.W && b == a.W && (a.I.g || a.I.callback()), Ze(a), (a.o = null));
                }
            },
            $e = function (a, b) {
        ...
        var gf = function (a, b) {
            ...
            ff = function (a, b, c, d, e) {
                ...
                for (var f = b.next(); !f.done; f = b.next()) {
                    f = f.value;
                    var g = a.g[f];
                    !e[f] && d(g) && ((e[f] = !0), ff(a, g.xc() || [], c, d, e), c(g));
                }
            };
        ...
        hf.prototype.next = function () {
            var a = this.g.next();
            return { value: a.done ? void 0 : this.h.call(void 0, a.value, this.j++), done: a.done };
        };
        var kf = function (a, b) {
            return new hf(a, b);
        };
        _.lf = "StopIteration" in _.p ? _.p.StopIteration : { message: "StopIteration", stack: "" };
        _.mf = function () {};
        ...
        _.vf = function (a, b) {
            ...
            if (1 < c) {
                ...
                if (a instanceof _.vf) for (c = a.Sb(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
        ...
        var Bf = [],
            Cf = function (a) {
                ...
                a.g &&
                    _.Tb(a.g, function (d) {
                        var e = d.id;
                        e instanceof A && d.module && (e.xj = d.module);
                    });
            };
...
*/
        ...
        _.Nf.prototype.ja = function (a) {
            a = a({}, this.j ? this.j.g() : {});
            this.h(null, "undefined" != typeof _.Of && a instanceof _.Of ? a.Db : null);
        };
        ...
        var cg = function (a, b, c, d, e, f) {
            if (Array.isArray(c)) for (var g = 0; g < c.length; g++) cg(a, b, c[g], d, e, f);
            else {
        ...
        _.J.prototype.sa = function (a, b, c, d, e) {
            if (Array.isArray(b)) for (var f = 0; f < b.length; f++) this.sa(a, b[f], c, d, e);
            else
                (c = c || this.handleEvent),
                    ...
                    (c = Rd(c)),
                    (d = !!d),
                    (b = _.Fd(a) ? a.cd(b, c, d, e) : a ? ((a = _.Td(a)) ? a.cd(b, c, d, e) : null) : null),
        ...
        var mg = function () {
            ...
            this.status = -1;
            this.statusText = "";
            this.g.onload = (0, _.x)(this.Lh, this);
            this.g.onerror = (0, _.x)(this.eg, this);
            this.g.onprogress = (0, _.x)(this.Ui, this);
            this.g.ontimeout = (0, _.x)(this.Zi, this);
        };
        _.h = mg.prototype;
        ...
        _.qg.prototype.W = function () {
            this.Bb() || (this.T || this.C || this.l ? zg(this) : this.ba());
        };
        ...
        var Hg = function (a, b, c, d, e) {
            ...
            Jg = function (a, b, c, d, e, f, g) {
                ...
                for (var k = b.next(); !k.done; k = b.next()) {
                    var l = k.value;
                    k = c[l];
                    (!e && (a.C.has(l) || k.g)) || g[l] || ((g[l] = !0), (l = d[l] ? Object.keys(d[l]) : []), Jg(a, k.xc().concat(l), c, d, e, f, g), f(k));
                }
            },
            ...
            Lg = function (a, b, c) {
                ...
                if (a.K) (a = _.kd(document, "SCRIPT")), _.Ta(a, _.fg(d)), (a.type = "text/javascript"), (a.async = !1), document.body.appendChild(a);
                else {
                    var e = new Ng(),
            ...
            Mg = function (a, b, c, d) {
                ...
                else for (k = 0; k < b.length; k++) (l = b[k]), Gg(l.o, l.Xb) || (c && c(8001));
                (e || g) &&
                    -1 != f &&
                    _.Tb(m, function (n) {
                        n.cancel();
    ...
    try {
        ...
        MSGFUNC_PAGE_TRANSLATED_TO = function (a) {
            return "Google ha traducido esta p\u00e1gina autom\u00e1ticamente al " + a + ".";
        };
        K[3] = MSGFUNC_PAGE_TRANSLATED_TO;
        MSGFUNC_TRANSLATED_TO = function (a) {
            return "Traducido al: " + a;
        };
        ...
        MSGFUNC_POWERED_BY = function (a) {
            return "Con la tecnolog\u00eda de " + a;
        };
        K[7] = MSGFUNC_POWERED_BY;
        MSG_TRANSLATE_PRODUCT_NAME = "Traductor de Google";
        K[8] = MSG_TRANSLATE_PRODUCT_NAME;
        MSG_TRANSLATION_IN_PROGRESS = "Traducci\u00f3n en curso";
        K[9] = MSG_TRANSLATION_IN_PROGRESS;
        MSGFUNC_TRANSLATE_PAGE_TO = function (a) {
            return "\u00bfQuieres traducir esta p\u00e1gina al " + a + "TARGET_LANGUAGE con el Traductor de Google?";
        };
        K[10] = MSGFUNC_TRANSLATE_PAGE_TO;
        MSGFUNC_VIEW_PAGE_IN = function (a) {
            return "Ver esta p\u00e1gina en: " + a;
        };
        K[11] = MSGFUNC_VIEW_PAGE_IN;
        MSG_RESTORE = "Mostrar texto original";
        K[12] = MSG_RESTORE;
        ...
        MSGFUNC_TURN_OFF_TRANSLATION = function (a) {
            return "Desactivar traducci\u00f3n del " + a;
        };
        ...
        MSG_SHOW_CANCEL_ALL = "Cancelar todo";
        ...
        MSG_DRAG_TIP = "Pulsa May\u00fas y arrastra las palabras para cambiar el orden.";
        K[35] = MSG_DRAG_TIP;
        MSG_CLICK_FOR_ALT = "Haz clic para obtener traducciones alternativas.";
        K[36] = MSG_CLICK_FOR_ALT;
        MSG_DRAG_INSTUCTIONS = "Mant\u00e9n pulsada la tecla May\u00fas y, a continuaci\u00f3n, haz clic en las palabras y arr\u00e1stralas para cambiar el orden.";
        K[37] = MSG_DRAG_INSTUCTIONS;
        MSG_SUGGESTION_SUBMITTED = "Gracias por proponer una traducci\u00f3n al Traductor de Google.";
        ...
        MSG_ALT_AND_CONTRIBUTE_ACTIVITY_HELPER_TEXT = "Haz clic en una palabra para obtener traducciones alternativas o doble clic para editar las traducciones directamente.";
        K[40] = MSG_ALT_AND_CONTRIBUTE_ACTIVITY_HELPER_TEXT;
        MSG_ORIGINAL_TEXT_NO_COLON = "Texto original";
        K[41] = MSG_ORIGINAL_TEXT_NO_COLON;
        K[42] = "Traductor de Google";
        K[43] = "Traducir";
        K[44] = "Se ha enviado tu correcci\u00f3n.";
        MSG_LANGUAGE_UNSUPPORTED = "Error: no se admite el idioma de la p\u00e1gina web.";
        K[45] = MSG_LANGUAGE_UNSUPPORTED;
        MSG_LANGUAGE_TRANSLATE_WIDGET = "Widget de idiomas del Traductor";
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.es.xvg8Pu_w8bE.O/d=1/rs=AN8SPfohaR5L5Ve8aXRNncnUOhUJf3jYig/m=el_conf
// Congigure Constants
(function () {
    ...
    (function () {
        ...
        c._cnal = {};
        _loadJs("https://translate.googleapis.com/_/translate_http/_/js/k\x3dtranslate_http.tr.es.xvg8Pu_w8bE.O/d\x3d1/exm\x3del_conf/ed\x3d1/rs\x3dAN8SPfohaR5L5Ve8aXRNncnUOhUJf3jYig/m\x3del_main");
        _exportMessages();
        _exportVersion("TE_20211101");
    })();
})();
