	...
	$.ajax({
		...
		success: function (resp) {
			...
			$.each(resp.data, function (pos, val) {
				...
				tabla+="<tr><td><img class='img-thumbnail' src='"+val.icono+"'></td><td>"+val.leccion+"</td><td>"+url+"</td><td>"+tipo+"</td>><td>"+estado+"</td><td><a onclick='editarGuia("+val.clave+", "+val.tipo+", "+val.modulo+","+val.leccionid+", "+val.estatus+")'><i class='fa fa-pencil' aria-hidden='true'></i> Editar</a></td></tr>";
			});
