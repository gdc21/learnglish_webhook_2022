            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="contenido">
                    <form action="" id="formularioAgregar">
                        ...
                        <input type="number" name="licencias" step="1" placeholder="Cantidad licencias" class="mb-2 form-control" required>
                        <hr>
                        <label>Fecha de inicio de contratación:</label>
                        <input type="date" name="fec_inicio" class="mb-2 form-control" required>
                        <hr>
                        <label>Fecha de finalización de contratación:</label>
                        <input type="date" name="fec_fin" class="mb-2 form-control" required>
        ...
        function accionesEliminar(){
            ...
            $('.eliminarRegistroCliente').click(function(){
                ...
                if(confirmar){
                    ...
                    data = getInfoAjax('eliminarestadisticacliente', {id:registro}, "admin");
                    if (data) {
                        $("#mensaje").show();
                        $('#mensaje').removeClass("alert-danger");
                        $('#mensaje').addClass("alert-success");
