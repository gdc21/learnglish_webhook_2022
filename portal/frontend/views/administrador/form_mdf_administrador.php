		...
		<div class="row">
			<div class="col-md-30">
				<table width="100%" border="0" cellspacing="10" cellpadding="0">
					<tr>
						<td width="65%"><span class="standard-block">Admin / Modificar
								usuario</span></td>
...
<div class="text-inter">
	<div class="container">
		<div class="row">
			<h2 align="center">
				<img src="<?= IMG ?>administradores.png"
					align="absmiddle"> Modificar usuario
			</h2>


			<form enctype="multipart/form-data" id="form_mdf_administrado" name="form_mdf_administrado">
				...
				<table width="70%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<input id="id_usuario" name="id_usuario" type="hidden"  value="<?= $this->temp["usuario"]["id"] ?>" size="30">
						
						<input
							name="nombre" id="nombre" placeholder="nombre" type="text" class="form-control input-lg"
							 value="<?= $this->temp ["usuario"]["nombre"] ?>"
					...
					<tr>
						...
						<td width="84%" align="left" bgcolor="#CCECE4"><input
							name="usuario" id="usuario" placeholder="Usuario" type="text" class="form-control input-lg"
							value="<?= $this->temp ["usuario"]["usuario"] ?>" size="30"><span
							class="error"></span></td>
					</tr>
					...
					<tr>
						...
						<td width="84%" align="left" bgcolor="#CCECE4"><input
							type="text" class="form-control input-lg"id="password" name="password" placeholder="*****"
							value="" size="30"><span
							class="error"></span></td>
					</tr>
								...
								<li class="list-group-item">
									<div class="material-switch pull-right">
										...
										<input name="permisos[]" type="checkbox"
											...
											<?php foreach ( $this->temp ["usuario"]["permisos"] as $permiso ) { ?>	
											<?php if($permiso == $contenido['id']){?>
												checked="checked"
												<?php } }?>
											/>
							...
							<li class="list-group-item">
								...
								<div class="material-switch pull-right">
									...
									<input id="estatus" name="estatus" type="checkbox"
										<?php if($this->temp ["usuario"]["activo"]==1){ ?> checked
										<?php }?> /> <label for="estatus" name="label" class="label"><?php if($this->temp ["usuario"]["activo"]==1){ ?> Activado
