...
TableTools.prototype = {
	...
	"_fnRowSelect": function ( src, e )
	{
		...
		|
		|	Date: 27/11/2014
		|	Summary: Condicionamos el select del row (Evitamos seleccion al hacer click en los inputs y selects)
		|
		*/
		//console.log(e)
		
		if(typeof  e == 'undefined'){
			seleccionarTodo(src, null, this)
		}else if(( e.target.localName != "input" && e.target.localName != "select" && e.target.localName != "div" && e.target.localName != "span" && e.target.localName != "ul" && e.target.localName != "li")){
			seleccionarTodo(src, e, this)
		}
	},
	...
	{
		if(typeof  e == 'undefined'){
			desseleccionarTodo(src, null, this)
		}else if(( e.target.localName != "input" && e.target.localName != "select" && e.target.localName != "div" && e.target.localName != "span" && e.target.localName != "ul" && e.target.localName != "li")){
			desseleccionarTodo(src, e, this)
		}
	},
...
function seleccionarTodo(src, e, obj){
	/*
	|
	|	Date: 27/11/2014
	|	Summary: Condicionamos el select del row (Evitamos seleccion al hacer click en los inputs y selects)
	...
	*/
	...
	if ( obj.s.select.preRowSelect !== null && !obj.s.select.preRowSelect.call(obj, e, anSelected, true) )
	{
		return;
	}
	...
	if ( obj.s.select.postSelected !== null )
	{
		obj.s.select.postSelected.call( obj, anSelected );
	}

	TableTools._fnEventDispatch( obj, 'select', anSelected, true );
}

function desseleccionarTodo(src, e, obj){
	/*
	|
	|	Date: 27/11/2014
	|	Summary: Condicionamos el select del row (Evitamos seleccion al hacer click en los inputs y selects)
	...
	*/
	...
	// User defined pre-selection function
	if ( obj.s.select.preRowSelect !== null && !obj.s.select.preRowSelect.call(obj, e, anDeselectedTrs, false) )
	{
		return;
	}
	...
	if ( obj.s.select.postDeselected !== null )
	{
		obj.s.select.postDeselected.call( obj, anDeselectedTrs );
	}

	TableTools._fnEventDispatch( obj, 'select', anDeselectedTrs, false );
}
