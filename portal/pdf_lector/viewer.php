...
<link rel="stylesheet" href="<?= PDF_LECTOR ?>viewer.css" />
<script src="<?= PDF_LECTOR ?>jquery.js"></script>

<script src="<?= PDF_LECTOR ?>compatibility.js"></script>



<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n"
	href="<?= PDF_LECTOR ?>locale/locale.properties" />
<script src="<?= PDF_LECTOR ?>l10n.js"></script>
<script src="<?= PDF_LECTOR ?>build/pdf.js"></script>

<script type="text/javascript">
      var file = "<?= $file_pdf ?>";
      function configure(PDFJS) {
		  PDFJS.imageResourcesPath = '<?= PDF_LECTOR ?>images/';
		  PDFJS.workerSrc = '<?= PDF_LECTOR ?>build/pdf.worker.js';
		  PDFJS.cMapUrl = '<?= PDF_LECTOR ?>cmaps/';
		  PDFJS.cMapPacked = true;
	}
 </script>
<script src="<?= PDF_LECTOR ?>debugger.js"></script>
<script src="<?= PDF_LECTOR ?>viewer.js"></script>
